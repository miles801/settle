...
(function (window, angular, $) {
    var app = angular.module('settle.report.groupVip.activity', [
        'eccrm.angular',
        'eccrm.angularstrap',
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, GroupVipService, GroupVipParam) {
        ...
        $scope.exportData = function () {
            ...
            o.start = null;
            o.limit = null;
            window.open(CommonUtils.contextPathURL('/settle/report/groupVip/export-activity?' + encodeURI(encodeURI($.param(o)))));
        };
