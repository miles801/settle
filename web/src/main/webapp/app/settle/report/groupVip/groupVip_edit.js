...
(function (window, angular, $) {
    var app = angular.module('settle.report.groupVip.edit', [
        'eccrm.angular',
        'eccrm.angularstrap',
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, GroupVipService, GroupVipParam) {
        ...
        $scope.save = function (createNew) {
            var promise = GroupVipService.save($scope.beans, function (data) {
        ...
        $scope.update = function () {
            var promise = GroupVipService.update($scope.beans, function (data) {
        ...
        $scope.load = function (id, callback) {
            var promise = GroupVipService.get({id: id}, function (data) {
