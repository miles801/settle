...
<body>
<div class="main" ng-app="settle.report.businessLog.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        ...
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="beans.vipName" validate validate-required
                                   maxlength="40"/>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
...
<script type="text/javascript" src="<%=contextPath%>/app/settle/report/businessLog/businessLog.js"></script>
<script type="text/javascript" src="<%=contextPath%>/app/settle/report/businessLog/businessLog_edit.js"></script>
</html>