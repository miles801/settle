...
<body>
<div class="main" ng-app="settle.sms.smsBuy.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        <div class="item w300">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.occurTime"
                                       eccrm-my97="{dateFmt:'yyyy-MM-dd HH:mm:ss'}" readonly placeholder="点击选择时间"/>
                                <span class="add-on"><i class="icons icon clock" ng-click="beans.occurTime=null"
                                                        title="点击清除"></i></span>
                            </div>
                        </div>
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="beans.counts" validate validate-required
                                   maxlength=""/>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
                            ...
                            <input type="text" class="w200" ng-model="beans.money" maxlength=""/>
                        </div>
                        <div class="item w900 break">
                            <div class="form-label w100">
                                <label>备注:</label>
                            </div>
                            <input type="text" class="w800" ng-model="beans.description" maxlength=""/>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=contextPath%>/app/settle/sms/smsBuy/smsBuy_edit.js"></script>
</html>