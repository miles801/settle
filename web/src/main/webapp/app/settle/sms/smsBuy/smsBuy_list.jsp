...
<body>
<div class="main condition-row-1" ng-app="settle.sms.smsBuy.list" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td>
                                    <a ng-click="view(foo.id)" bo-text="foo.occurTime" class="cp" title="点击查看详情"></a>
                                </td>
...
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/sms/smsBuy/smsBuy.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/sms/smsBuy/smsBuy_list.js"></script>
</html>