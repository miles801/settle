...
<body>
<div class="main condition-row-1" ng-app="settle.conf.stepPercent.list" ng-controller="Ctrl">
...
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/conf/stepPercent/stepPercent.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/conf/stepPercent/stepPercent_list.js"></script>
</html>