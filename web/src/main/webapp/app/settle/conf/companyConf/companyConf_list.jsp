...
<body>
<div class="main condition-row-1" ng-app="settle.conf.companyConf.list" ng-controller="Ctrl">
...
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/conf/companyConf/companyConf.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/settle/conf/companyConf/companyConf_list.js"></script>
</html>