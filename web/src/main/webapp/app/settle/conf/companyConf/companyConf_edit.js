...
(function (window, angular, $) {
    var app = angular.module('settle.conf.companyConf.edit', [
        'eccrm.angular',
        'eccrm.angularstrap',
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, CompanyConfService, CompanyConfParam) {
        ...
        $scope.save = function (createNew) {
            var promise = CompanyConfService.save($scope.beans, function (data) {
        ...
        $scope.update = function () {
            var promise = CompanyConfService.update($scope.beans, function (data) {
        ...
        $scope.load = function (id, callback) {
            var promise = CompanyConfService.get({id: id}, function (data) {
