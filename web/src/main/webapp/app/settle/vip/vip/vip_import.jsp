...
<body>
<div class="main" ng-app="settle.vip.vip.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/settle/vip/vip/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app//settle/vip/vip/vip_import.js"></script>
</html>
