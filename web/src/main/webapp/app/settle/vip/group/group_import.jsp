...
<body>
<div class="main" ng-app="settle.vip.group.import" ng-controller="Ctrl">
    <div class="block">
...
<script type="text/javascript" src="<%=contextPath%>/app//settle/vip/group/group_import.js"></script>
</html>
