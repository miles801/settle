    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, BusinessService, BusinessParam) {
        ...
        $scope.enable = function (id) {
            ModalFactory.confirm({
                ...
                callback: function () {
                    var promise = BusinessService.enable({ids: id}, function () {
        ...
        $scope.disable = function (id) {
            ModalFactory.confirm({
                ...
                callback: function () {
                    var promise = BusinessService.disable({ids: id}, function () {
                        AlertFactory.success('操作成功!');
                        $scope.query();
                    });
                    CommonUtils.loading((promise));
        ...
        $scope.exportData = function () {
            ...
            o.start = null;
            o.limit = null;
            window.open(CommonUtils.contextPathURL('/settle/vip/business/export?' + encodeURI(encodeURI($.param(o)))));
        };
