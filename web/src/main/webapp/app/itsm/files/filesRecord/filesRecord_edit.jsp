...
<body>
<div class="main" ng-app="itsm.files.filesRecord.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/files/filesRecord/filesRecord_edit.js"></script>
</html>