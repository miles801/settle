                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td style="width: 60px;">级别
                                    <span class="cp" ng-show="condition.reverse" ng-click="reverse(false)" title="点击降序">▼</span>
                                    <span class="cp" ng-show="!condition.reverse" ng-click="reverse(true)" title="点击升序">▲</span>
                                </td>
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td class="text-left ">
                                    <a ng-href="<%=contextPath%>/attachment/download-all?bid={{foo.id}}"
                                ...
                                <td>
                                    <span class="bgc" ng-class="{'green':!foo.deleted,'red':foo.deleted}"
                                          bo-text="foo.deleted?'禁用':'启用'"></span>
                                </td>
                                <td>
                                    <a ng-click="viewCallback(foo.id)" class="cp" title="点击查看详情"
                                       bo-text="foo.callbacks||0"></a>
                                </td>
                                <td class="text-left">
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/files/filesRecord/filesRecord.js"></script>
<script type="text/javascript" src="<%=contextPath%>/app/itsm/files/files/files_list.js"></script>
</html>