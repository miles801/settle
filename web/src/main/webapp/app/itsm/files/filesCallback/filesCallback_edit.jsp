...
<body>
<div class="main" ng-app="itsm.files.filesCallback.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        <div class="item w900 break">
                            ...
                            <textarea class="w800" rows="4" ng-model="beans.content" maxlength="1000" validate
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/files/filesCallback/filesCallback_edit.js"></script>
</html>