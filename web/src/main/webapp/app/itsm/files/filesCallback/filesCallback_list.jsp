...
<body>
<div class="main condition-row-1" ng-app="itsm.files.filesCallback.list" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td>
                                    <a ng-click="view(foo.id)" bo-text="foo.content" class="cp" title="点击查看详情"></a>
                                </td>
                                <td class="text-left">
...
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/files/filesCallback/filesCallback.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/files/filesCallback/filesCallback_list.js"></script>
</html>