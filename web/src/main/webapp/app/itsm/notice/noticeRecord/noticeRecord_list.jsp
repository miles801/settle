...
<body>
<div class="main condition-row-1" ng-app="itsm.notice.noticeRecord.list" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td bo-text="foo.hasRead"></td>
                                <td bo-text="foo.readTime"></td>
                                <td class="text-left">
...
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/notice/noticeRecord/noticeRecord.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/notice/noticeRecord/noticeRecord_list.js"></script>
</html>