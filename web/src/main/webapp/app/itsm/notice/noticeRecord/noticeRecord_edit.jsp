...
<body>
<div class="main" ng-app="itsm.notice.noticeRecord.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="beans.receiverName" validate validate-required
                                   maxlength="40"/>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
                            ...
                            <input type="text" class="w200" ng-model="beans.hasRead" validate validate-required
                                   maxlength=""/>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.readTime"
                                       eccrm-my97="{dateFmt:'yyyy-MM-dd HH:mm:ss'}" readonly placeholder="点击选择时间"/>
                                <span class="add-on"><i class="icons icon clock" ng-click="beans.readTime=null"
                                                        title="点击清除"></i></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/notice/noticeRecord/noticeRecord_edit.js"></script>
</html>