...
<body>
<div class="main condition-row-1" ng-app="itsm.notice.noticeReceiver.list" ng-controller="Ctrl">
                ...
                <div class="content-wrap">
                    <div class="row float">
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="condition.type"
                                   maxlength="20"/>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/notice/noticeReceiver/noticeReceiver.js"></script>
<script type="text/javascript"
        src="<%=contextPath%>/app/itsm/notice/noticeReceiver/noticeReceiver_list.js"></script>
</html>