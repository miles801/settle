...
<body>
<div class="main" ng-app="itsm.notice.noticeReceiver.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="beans.type" validate validate-required
                                   maxlength="20"/>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/notice/noticeReceiver/noticeReceiver.js"></script>
<script type="text/javascript" src="<%=contextPath%>/app/itsm/notice/noticeReceiver/noticeReceiver_edit.js"></script>
</html>