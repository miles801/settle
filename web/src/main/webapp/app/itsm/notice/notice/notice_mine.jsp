...
<body>
<div class="main condition-row-1" ng-app="itsm.notice.notice.mine" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td>
                                    <span class="bgc" ng-class="{'red':!foo.hasRead,green:foo.hasRead}"
                                          bo-text="foo.hasRead?'是':'否'"></span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/notice/notice/notice_mine.js"></script>
</html>