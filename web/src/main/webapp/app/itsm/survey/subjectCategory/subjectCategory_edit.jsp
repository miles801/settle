...
<body>
<div class="main" ng-app="itsm.survey.subjectCategory.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        ...
                        <div class="item w300 break;">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.parentName" readonly
                                       ztree-single="parentTree"/>
                                <span class="add-on"><i class="icons icon fork" ng-click="clearParent();"></i></span>
                            </div>
                        </div>
                        <div class="item w300 break;">
                            <div class="form-label w100">
                            ...
                            <input type="text" class="w200" ng-model="beans.sequenceNo" validate validate-int
                                   placeholder="整形数字"/>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/survey/subjectCategory/subjectCategory_edit.js"></script>
</html>