 ...
 */
(function (angular) {
    var app = angular.module('itsm.survey.subjectCategory', [
        'ngResource',
        'eccrm.angular',
        'base.param',
        'eccrm.angularstrap'
    ...
    app.service('SubjectCategoryService', function (CommonUtils, $resource) {
        return $resource(CommonUtils.contextPathURL('/itsm/survey/subjectCategory/:method'), {}, {
            // 保存
    ...
    app.service('SubjectCategoryParam', function (ParameterLoader, CommonUtils, SubjectCategoryService) {
        var o = {
            /**
                ...
                return {
                    data: function () {
                        return CommonUtils.promise(function (defer) {
                            var promise = SubjectCategoryService.queryValid(function (data) {
