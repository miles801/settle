...
<body>
<div class="main condition-row-1" ng-app="itsm.survey.subjectCategory.list" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td><a ng-class="{'red':foo.deleted}" class="btn-op" bo-text="foo.deleted?'是':''"></a>
                                </td>
                                <td class="text-left">
                                    <a class="btn-op blue" ng-click="modify(foo.id);">编辑</a>
                                    <a class="btn-op green" ng-click="enable(foo.id);">启用</a>
                                    <a class="btn-op red" ng-click="disable(foo.id);">禁用</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/survey/subjectCategory/subjectCategory_list.js"></script>
</html>