 ...
 */
(function (angular) {
    var app = angular.module('itsm.survey.subject', [
        'ngResource',
        'eccrm.angular',
        'base.param',
        'eccrm.angularstrap'
    ...
    app.service('SubjectService', function (CommonUtils, $resource) {
        return $resource(CommonUtils.contextPathURL('/itsm/survey/subject/:method'), {}, {
            // 保存
    ...
    app.service('SubjectParam', function (ParameterLoader, CommonUtils, SubjectService) {
        var o = {
            /**
                ...
                return {
                    data: function () {
                        return CommonUtils.promise(function (defer) {
                            var promise = SubjectService.queryValid(function (data) {
        ...
        o['type'] = function (callback) {
            ParameterLoader.loadSysParam('SUBJECT_TYPE', callback);
        };
