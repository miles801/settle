...
<body>
<div class="main" ng-app="itsm.survey.subject.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/itsm/survey/subject/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app//itsm/survey/subject/subject_import.js"></script>
</html>
