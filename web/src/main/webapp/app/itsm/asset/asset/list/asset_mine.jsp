                    ...
                    <div class="row float">
                        <div class="item w250">
                            <div class="form-label w100">
                                <label validate-error="form.name">资产类型:</label>
                            </div>
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td>
                                    <a class="cp" ng-click="foo.ip && setManageRisk(foo.id,foo.assetType1);"
                                       bo-text="foo.manageRiskValue||'未评估'" ng-disabled="!foo.ip"></a>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="btn-op yellow" ng-click="cloneAsset(foo.id);">克隆 </a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
