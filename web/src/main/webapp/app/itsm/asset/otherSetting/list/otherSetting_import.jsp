...
<body>
<div class="main" ng-app="itsm.asset.otherSetting.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/itsm/otherSetting/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/asset/otherSetting/list/otherSetting_import.js"></script>
</html>
