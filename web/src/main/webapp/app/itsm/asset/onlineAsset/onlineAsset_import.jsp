...
<body>
<div class="main" ng-app="itsm.asset.onlineAsset.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/itsm/asset/onlineAsset/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app//itsm/asset/onlineAsset/onlineAsset_import.js"></script>
</html>
