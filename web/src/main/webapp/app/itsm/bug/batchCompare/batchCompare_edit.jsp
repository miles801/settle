...
<body>
<div class="main" ng-app="itsm.bug.batchCompare.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        <div class="item w300">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.batchId1" validate validate-required
                                       maxlength="40" placeholder="点击选择" readonly ng-click="pick(1);"/>
                                <span class="add-on"><i class="icons icon fork" ng-click="clear(1);"></i></span>
                            </div>
                        </div>
                        <div class="item w300">
                            <div class="form-label w100">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.batchId2" validate validate-required
                                       maxlength="40" placeholder="点击选择" readonly ng-click="pick(2);"/>
                                <span class="add-on"><i class="icons icon fork" ng-click="clear(2);"></i></span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/bug/batchCompare/batchCompare_edit.js"></script>
</html>