...
<body>
<div class="main" ng-app="itsm.bug.bugOther.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/itsm/bug/bugOther/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app//itsm/bug/bugOther/bugOther_import.js"></script>
</html>
