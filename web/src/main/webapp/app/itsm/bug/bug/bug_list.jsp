...
<body>
<div class="main condition-row-2" ng-app="itsm.bug.bug.list" ng-controller="Ctrl">
                ...
                <div class="content-wrap">
                    <div class="row float">
                        ...
                        <div class="item w300">
                            ...
                            <select class="w200" ng-model="condition.riskLevel" name="riskLevel"
                        ...
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="condition.ip" maxlength="40"/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="list-result ">
        <div class="block">
            <div class="block-header">
                ...
                <span class="header-button">
                    <a class="btn btn-green" ng-cloak ng-disabled="!anyone" ng-click="commit();">安排整改</a>
                    ...
                    <a class="btn btn-green btn-min" ng-click="remove();" ng-disabled="!anyone" ng-cloak> 删除 </a>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td class="text-left">
                                    ...
                                    <a class="btn-op red" ng-if="foo.status=='NOT_START'"
                                       ng-click="remove(foo.id);">删除</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="<%=contextPath%>/app/itsm/bug/bug/bug_list.js"></script>
</html>