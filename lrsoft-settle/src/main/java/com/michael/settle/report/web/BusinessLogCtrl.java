 ...
 */
@Controller
@RequestMapping(value = {"/settle/report/businessLog"})
public class BusinessLogCtrl extends BaseController {
    @Resource
    ...
    public String toList() {
        return "settle/report/businessLog/businessLog_list";
    }

    @RequestMapping(value = "/add", method = RequestMethod.GET)
    public String toAdd(HttpServletRequest request) {
        request.setAttribute(JspAccessType.PAGE_TYPE, JspAccessType.ADD);
        return "settle/report/businessLog/businessLog_edit";
    }

    @RequestMapping(value = "/save", method = RequestMethod.POST)
    @ResponseBody
    public void save(HttpServletRequest request, HttpServletResponse response) {
        BusinessLog businessLog = GsonUtils.wrapDataToEntity(request, BusinessLog.class);
    ...
    public void findById(@RequestParam String id, HttpServletResponse response) {
        BusinessLogVo vo = businessLogService.findById(id);
    ...
    public void pageQuery(HttpServletRequest request, HttpServletResponse response) {
        ...
        PageVo pageVo = businessLogService.pageQuery(bo);
    ...
    public void query(HttpServletRequest request, HttpServletResponse response) {
        BusinessLogBo bo = GsonUtils.wrapDataToEntity(request, BusinessLogBo.class);
        List<BusinessLogVo> vos = businessLogService.query(bo);
    ...
    public void deleteByIds(@RequestParam String ids, HttpServletResponse response) {
        ...
        businessLogService.deleteByIds(idArr);
        GsonUtils.printSuccess(response);
    }
    ...
    public String export(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            disposition = "attachment;filename=" + URLEncoder.encode("交易历史数据" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + ".xlsx", "UTF-8");
        ...
        try {
            InputStream inputStream = BusinessLogCtrl.class.getClassLoader().getResourceAsStream("export_businessLog.xlsx");
    ...
    public void downloadTemplate(HttpServletResponse response) {
        InputStream input = BusinessLogCtrl.class.getClassLoader().getResourceAsStream("import_businessLog.xlsx");
        Assert.notNull(input, "模板下载失败!交易历史数据导入模板不存在!");
        response.setContentType("application/vnd.ms-excel");
        String disposition = null;//
        try {
            disposition = "attachment;filename=" + URLEncoder.encode("交易历史数据导入模板.xlsx", "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        response.setHeader("Content-disposition", disposition);
